...
def sac(env, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), dynamics_kwargs=dict(),
        ...
        polyak=0.9, lr=1e-3, alpha=0.2, beta=0.1, if_cbf=False, batch_size=64, start_steps=10,
    ...
    def compute_loss_q(data):
        o, a, r, o2, d, c = data['obs'], data['act'], data['rew'], data['obs2'], data['done'], data['cost']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--if_cbf', type=bool, default=True)
